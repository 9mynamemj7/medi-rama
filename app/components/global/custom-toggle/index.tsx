...
const CustomToggle = ({
  ...
  const handleToggleChange = (event: any) => {
    ...
    setData(prevData => ({...prevData, pilot: value ? "true" : "false"}))
    setInputData({pilot: value ? "true" : "false"})
  }
  return (
    <label className="inline-flex items-center cursor-pointer">
      ...
      <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">pilot study</span>
    </label>
  )
}
